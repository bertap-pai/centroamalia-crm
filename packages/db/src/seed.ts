...
const PROPERTY_DEFINITIONS: PropDef[] = [
  ...
  { key: 'first_meta_ad_id', label: 'First meta ad ID', scope: 'contact', type: 'text' },
  { key: 'last_meta_ad_id', label: 'Last meta ad ID', scope: 'contact', type: 'text' },
  { key: 'first_meta_ad_name', label: 'First meta ad name', scope: 'contact', type: 'text' },
  { key: 'last_meta_ad_name', label: 'Last meta ad name', scope: 'contact', type: 'text' },
  { key: 'first_meta_adset_id', label: 'First meta adset ID', scope: 'contact', type: 'text' },
  { key: 'last_meta_adset_id', label: 'Last meta adset ID', scope: 'contact', type: 'text' },
  { key: 'first_meta_adset_name', label: 'First meta adset name', scope: 'contact', type: 'text' },
  { key: 'last_meta_adset_name', label: 'Last meta adset name', scope: 'contact', type: 'text' },
  { key: 'first_meta_campaign_id', label: 'First meta campaign ID', scope: 'contact', type: 'text' },
  { key: 'last_meta_campaign_id', label: 'Last meta campaign ID', scope: 'contact', type: 'text' },
